            ...
            <div class="row">
                ...
                <div class="col-lg-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form class="row g-2" action="{{ route('page.team.update', $pageData?->id) }}" method="POST"
                                ...
                                <div class="col-6 p-2 text-center">
                                    <div>
                                        <img id="profileImage2"
                                            src="{{ asset($pageData?->team_image ? $pageData?->team_image : 'admin/assets/img/1920X1080.svg') }}"
                                            alt="Image" width="50%">
                                        <div class="pt-2">
                                            <!-- Hidden File Input -->
