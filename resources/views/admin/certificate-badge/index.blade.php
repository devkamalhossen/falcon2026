...
@section('title', 'Certificate Badges')
@section('styles')
    <style>
        .dropdown-menu li a {
            display: flex;
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <table class="table datatable">
                                ...
                                <tbody>
                                    @foreach ($certificateBadges as $item)
                                        <tr>
                                            <td>
                                                @if ($item->image)
                                                    ...
                                                    <div class="dropdown">
                                                        ...
                                                        <ul class="dropdown-menu">
                                                            <li><a class="dropdown-item"
                                                                    href="{{ route('certificate-badge.edit', $item->id) }}"><i
                                                                        class="bx bxs-edit-alt"></i> Edit</a></li>
                                                            <li>
                                                                <form action="{{ route('certificate-badge.destroy', $item->id) }}"
                                                                    method="POST">
                                                                    @csrf
                                                                    @method('DELETE')
                                                            ...
                                                            <li>
                                                                <a href="{{ route('certificate.badge.status.update', $item->id) }}"
                ...
                <div class="col-lg-4">
                    <div class="card">
                        @if ($certificate_badge)
                            <div class="card-body">
                                <form class="row g-2" action="{{ route('certificate-badge.update', $certificate_badge->id) }}" method="POST"
                                    enctype="multipart/form-data">
                                    @csrf
                                    @method('PUT')
                                    <div class="col-12 p-2 text-center">
                                        <div>
                                            <img id="profileImage" src="{{ asset($certificate_badge->image) }}"
                                                alt="image" width="30%">
                                            <div class="pt-2">
                                                <!-- Hidden File Input -->
                                    ...
                                    <div class="col-12">
                                        ...
                                        <select name="is_active" id="" class="form-control" required>
                                            <option {{$certificate_badge->is_active == 1 ? 'selected':''}} value="1">Active</option>
                                            <option {{$certificate_badge->is_active == 0 ? 'selected':''}} value="0">Inactive</option>
                                        </select>
                                        @error('is_active')
                                            <span class="text-danger">{{ $message }}</span>
                                        @enderror
                                    ...
                                    <div class="text-end">
                                        <a href="{{route('certificate-badge.index')}}" class="btn btn-sm btn-danger">Cancel</a>
                        ...
                        @else
                            <div class="card-body">
                                <form class="row g-2" action="{{ route('certificate-badge.store') }}" method="POST"
                                    enctype="multipart/form-data">
                                    @csrf
                                    <div class="col-12 p-2 text-center">
                                        <div>
                                            <img id="profileImage" src="{{ asset('admin/assets/img/100X100.svg') }}"
                                                alt="image" width="30%">
                                            <div class="pt-2">
                                                <!-- Hidden File Input -->
                                                <input type="file" name="image" id="profileImageInput"
    ...
    <script>
        ...
        document.getElementById('removeImageButton').addEventListener('click', function(e) {
            ...
            document.getElementById('profileImage').setAttribute('src',
                '{{ asset('admin/assets/img/100X100.svg') }}');
        });
    </script>
@endsection
