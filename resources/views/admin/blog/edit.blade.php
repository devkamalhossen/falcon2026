...
@section('main')
    <main id="main" class="main">
        ...
        <section class="section">
            <div class="row">
                <div class="col-lg-12">
                    <form action="{{ route('blog.update', $blog->id) }}" method="POST" id="blogForm" enctype="multipart/form-data">
                        @csrf
                        @method("PUT")
                        <div class="card">
                            <div class="card-body">
                                <div class="row py-4">
                                    <div class="col-6 col-lg-6 col-md-6">
                                        <div class="mb-2">
                                            ...
                                            <input type="text" name="title" placeholder="Title"
                                                class="form-control @error('title') is-invalid @enderror" id="title" value="{{$blog->title}}">
                                            @error('title')
                                        ...
                                        <div class="mb-2">
                                            ...
                                            <input type="text" name="slug" placeholder="slug"
                                                class="form-control @error('slug') is-invalid @enderror" id="slug" value="{{$blog->slug}}">
                                            @error('slug')
                                                <span class="text-danger">{{ $message }}</span>
                                            @enderror
                                        </div>
                                        ...
                                        <div class="mb-2">
                                            ...
                                            <select name="is_active" id="" class="form-control" required>
                                                <option {{$blog->is_active == 1 ? 'selected':''}} value="1">Active</option>
                                                <option {{$blog->is_active == 0 ? 'selected':''}} value="0">Inactive</option>
                                            </select>
                                            @error('is_active')
                                                <span class="text-danger">{{ $message }}</span>
                                            @enderror
                                    ...
                                    <div class="col-6 p-2 text-center">
                                        <div>
                                            <img id="profileImage" src="{{ asset($blog->image) }}"
                                 ...
                                 <div class="row">
                                    <div class="col-lg-12">
                                        ...
                                        <textarea rows="3" name="blog_excerpt" placeholder="Excerpt"
                                            class="form-control @error('blog_excerpt') is-invalid @enderror" id="blog_excerpt">{{ $blog->blog_excerpt }}</textarea>
                                        @error('blog_excerpt')
                                            <span class="text-danger">{{ $message }}</span>
                                        @enderror
                                    </div>
                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="quill-editor-full">{!! $blog->post_content !!}</div>
                                <input type="hidden" name="post_content" id="post_content" value="{{$blog->post_content}}" />
                            </div>
                        </div>
                        <div class="card">
                            <div class="card-body">
                                    ...
                                    <div class="col-12 col-lg-12 col-md-12">
                                        <div class="mb-2">
                                            ...
                                            <input type="text" name="meta_title" placeholder="Meta Title"
                                                ...
                                                id="meta_title" value="{{$blog->meta_title}}">
                                            @error('meta_title')
                                                <span class="text-danger">{{ $message }}</span>
                                            @enderror
                                        </div>
                                        <div class="mb-2">
                                            ...
                                            <textarea rows="4" name="meta_description" placeholder="Meta Description"
                                                class="form-control @error('meta_description') is-invalid @enderror" id="meta_description">{{$blog->meta_description}}</textarea>
                                        ...
                                        <div class="mb-2">
                                            ...
                                            <textarea rows="4" name="meta_keywords" placeholder="Meta Keywords"
                                                class="form-control @error('meta_keywords') is-invalid @enderror" id="meta_keywords">{{$blog->meta_keywords}}</textarea>
                                            @error('meta_keywords')
                                                <span class="text-danger">{{ $message }}</span>
                                            @enderror
                                        </div>
