        ...
        <section class="section">
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <div class="card">
                        <div class="card-body">
                            <form class="row g-2" action="{{ route('user.update', $user->id) }}" method="POST"
                                enctype="multipart/form-data">
                                @csrf
                                @method('PUT')
                                <div class="col-12 p-2 text-center">
                                    <div>
                                        <img id="profileImage" src="{{ asset($user->image) }}" alt="Profile"
                                ...
                                <div class="col-12 col-lg-6 col-md-6">
                                    ...
                                    <input type="text" name="number" placeholder="Phone Number"
                                        ...
                                        value="{{ $user->number }}" id="phone" required>
                                    @error('number')
                                        <span class="text-danger">{{ $message }}</span>
                                    @enderror
                                </div>
