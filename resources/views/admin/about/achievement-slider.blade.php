...
@section('title', 'Achievement Slider ')
@section('styles')
    <style>
        .dropdown-menu li a {
            display: flex;
            ...
            <div class="row">
                                                    ...
                                                    <div class="dropdown">
                                                        ...
                                                        <ul class="dropdown-menu">
                                                            <li><a class="dropdown-item"
                                                                    href="{{ route('slider.edit', $item->id) }}"><i
                                                            ...
                                                            <li>
                                                                <a href="{{ route('achievement.slider.status.update', $item->id) }}"
                ...
                <div class="col-lg-4">
                    <div class="card">
                        @if ($slider)
                            <div class="card-body">
                                <form class="row g-2" action="{{ route('slider.update', $slider->id) }}" method="POST"
                                    enctype="multipart/form-data">
                                    @csrf
                                    @method('PUT')
                                    <div class="col-12 p-2 text-center">
                                        <div>
                                            <img id="profileImage" src="{{ asset($slider->image) }}"
                                                alt="Image" width="30%">
                                            <div class="pt-2">
                                                <!-- Hidden File Input -->
                                    ...
                                    <div class="col-12 col-lg-6 col-md-6">
                                        ...
                                        <select name="is_active" id="" class="form-control" required>
                                            <option {{$slider->is_active == 1 ? 'selected':''}} value="1">Active</option>
                                            <option {{$slider->is_active == 0 ? 'selected':''}} value="0">Inactive</option>
                                        </select>
                                        @error('is_active')
                                            <span class="text-danger">{{ $message }}</span>
                                        @enderror
                                    ...
                                    <div class="text-end">
                                        <a href="{{route('slider.index')}}" class="btn btn-sm btn-danger">Cancel</a>
                        ...
                        @else
                            <div class="card-body">
                                <form class="row g-2" action="{{ route('slider.store') }}" method="POST"
                                    enctype="multipart/form-data">
                                    @csrf
                                    <div class="col-12 p-2 text-center">
                                        <div>
                                            <img id="profileImage" src="{{ asset('admin/assets/img/400X450.svg') }}"
                                                alt="image" width="30%">
                                            <div class="pt-2">
                                                <!-- Hidden File Input -->
                                                <input type="file" name="image" id="profileImageInput"
    ...
    <script>
        ...
        document.getElementById('removeImageButton').addEventListener('click', function(e) {
            ...
            document.getElementById('profileImage').setAttribute('src',
                '{{ asset('admin/assets/img/400X450.svg') }}');
        });
    </script>
@endsection
