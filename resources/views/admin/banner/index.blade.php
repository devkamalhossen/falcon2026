                                            ...
                                            <td>
                                                @if ($item->image)
                                                    <img src="{{ asset($item->image) }}" class="rounded" alt=""
                                                        width="100">
                                                @else
                                                    <img src="{{ asset('admin/assets/img/1980X920.svg') }}"
                                                ...
                                                <div class="d-flex align-items-center justify-start gap-2">
                                                    <div class="dropdown">
                                                        ...
                                                        <ul class="dropdown-menu">
                                                            ...
                                                            <li>
                                                                <a href="{{route('banner.status.update',$item->id)}}" class="text-{{$item->is_active == 1 ? 'danger':'success'}}"><i class="ri-eye-{{$item->is_active == 1 ? 'off-':''}}line"></i>   {{$item->is_active == 1? ' Turn Disable':' Turn Active'}}</a>
                                                            </li>
                                                        </ul>
                                                    </div>
