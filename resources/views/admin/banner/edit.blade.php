        ...
        <section class="section">
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <div class="card">
                        <div class="card-body">
                            <form class="row g-2" action="{{ route('banner.update', $banner->id) }}" method="POST"
                                enctype="multipart/form-data">
                                @csrf
                                @method('PUT')
                                <div class="col-12 p-2 text-center">
                                    <div>
                                        <img id="profileImage" src="{{ asset($banner->image) }}"
                                ...
                                <div class="col-12 col-lg-6 col-md-6">
                                    ...
                                    <input type="text" name="alt_name" placeholder="Alter Name" value="{{$banner->alt_name}}"
                                ...
                                <div class="col-12 col-lg-6 col-md-6">
                                    ...
                                    <select name="is_active" id="" class="form-control" required>
                                        ...
                                        <option {{$banner->is_active == 0 ? 'selected':''}} value="0">Inactive</option>
                                    </select>
                                    @error('is_active')
                                        <span class="text-danger">{{ $message }}</span>
                                    @enderror
