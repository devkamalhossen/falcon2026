            ...
            <div class="row">
                                                    ...
                                                    <div class="dropdown">
                                                        ...
                                                        <ul class="dropdown-menu">
                                                            <li><a class="dropdown-item"
                                                                    href="{{ route('client.edit', $item->id) }}"><i
                                                            ...
                                                            <li>
                                                                <a href="{{ route('client.status.update', $item->id) }}"
                ...
                <div class="col-lg-4">
                    <div class="card">
                        @if ($client)
                            <div class="card-body">
                                <form class="row g-2" action="{{ route('client.update', $client->id) }}" method="POST"
                                    enctype="multipart/form-data">
                                    @csrf
                                    @method('PUT')
                                    <div class="col-12 p-2 text-center">
                                        <div>
                                            <img id="profileImage" src="{{ asset($client->image) }}"
                                    ...
                                    <div class="col-12 col-lg-6 col-md-6">
                                        ...
                                        <input type="text" name="alt_name" placeholder="Alter Name" value="{{$client->alt_name}}"
                                    ...
                                    <div class="col-12 col-lg-6 col-md-6">
                                        ...
                                        <select name="is_active" id="" class="form-control" required>
                                            <option {{$client->is_active == 1 ? 'selected':''}} value="1">Active</option>
                                            <option {{$client->is_active == 0 ? 'selected':''}} value="0">Inactive</option>
                                        </select>
                                        @error('is_active')
                                            <span class="text-danger">{{ $message }}</span>
                                        @enderror
                        ...
                        @else
                            <div class="card-body">
                                <form class="row g-2" action="{{ route('client.store') }}" method="POST"
                                    enctype="multipart/form-data">
                                    @csrf
                                    <div class="col-12 p-2 text-center">
                                        <div>
                                            <img id="profileImage" src="{{ asset('admin/assets/img/350X165.svg') }}"
                                                alt="Client Iimage" width="30%">
                                            <div class="pt-2">
                                                <!-- Hidden File Input -->
                                                <input type="file" name="image" id="profileImageInput"
