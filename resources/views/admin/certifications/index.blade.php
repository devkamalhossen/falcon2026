            ...
            <div class="row">
                                                    ...
                                                    <div class="dropdown">
                                                        ...
                                                        <ul class="dropdown-menu">
                                                            <li><a class="dropdown-item"
                                                                    href="{{ route('certification.edit', $item->id) }}"><i
                                                            ...
                                                            <li>
                                                                <a href="{{ route('certification.status.update', $item->id) }}"
                ...
                <div class="col-lg-4">
                    <div class="card">
                        @if ($certification)
                            <div class="card-body">
                                <form class="row g-2" action="{{ route('certification.update', $certification->id) }}" method="POST"
                                    enctype="multipart/form-data">
                                    @csrf
                                    @method('PUT')
                                    <div class="col-12 p-2 text-center">
                                        <div>
                                            <img id="profileImage" src="{{ asset($certification->image) }}"
                                                alt=" Iimage" width="30%">
                                            <div class="pt-2">
                                                <!-- Hidden File Input -->
                                    ...
                                    <div class="col-12 col-lg-6 col-md-6">
                                        ...
                                        <select name="is_active" id="" class="form-control" required>
                                            <option {{$certification->is_active == 1 ? 'selected':''}} value="1">Active</option>
                                            <option {{$certification->is_active == 0 ? 'selected':''}} value="0">Inactive</option>
                                        </select>
                                        @error('is_active')
                                            <span class="text-danger">{{ $message }}</span>
                                        @enderror
                                    ...
                                    <div class="text-end">
                                        <a href="{{route('certification.index')}}" class="btn btn-sm btn-danger">Cancel</a>
                        ...
                        @else
                            <div class="card-body">
                                <form class="row g-2" action="{{ route('certification.store') }}" method="POST"
                                    enctype="multipart/form-data">
                                    @csrf
                                    <div class="col-12 p-2 text-center">
                                        <div>
