    ...
    <main id="main" class="main">
        ...
        <div class="pagetitle">
            ...
            <div class="d-flex align-items-center justify-content-between flex-wrap">
                ...
                <a href="{{ route('service.index') }}" class="btn btn-primary btn-sm">Go Back</a>
            </div>
        </div><!-- End Page Title -->
        ...
        <section class="section">
            <div class="row">
                <div class="col-lg-12">
                    <form action="{{ route('service.update', $service->id) }}" method="POST" id="serviceAreaForm"
                            ...
                            <div class="card-body">
                                <div class="row py-4">
                                    <div class="col-6 col-lg-6 col-md-6">
                                        ...
                                        <div class="mb-2">
                                            ...
                                            <select name="is_active" id="" class="form-control" required>
                                                <option {{ $service->is_active == 1 ? 'selected' : '' }} value="1">
                                                    Active</option>
                                                <option {{ $service->is_active == 0 ? 'selected' : '' }} value="0">
                                                    Inactive</option>
                                            </select>
                                            @error('is_active')
                                                <span class="text-danger">{{ $message }}</span>
                                    ...
                                    <div class="col-6 p-2 text-center">
                                        <div>
                                            <img id="profileImage" src="{{ asset($service?->image) }}" alt="Profile"
                                                width="50%">
                                            <div class="pt-2">
                                                <!-- Hidden File Input -->
                        ...
                        {{-- <div class="card">
                            <div class="card-body" style="height: 400px;padding-top: 20px;">
                                <div class="service-area-quill-editor-full" style="border: none;">{!! $service?->description !!}
                                </div>
                                    ...
                                    <div class="col-12 col-lg-12 col-md-12">
                                        <div class="mb-2">
                                            ...
                                            <input type="text" name="meta_title" placeholder="Meta Title"
                                                ...
                                                id="meta_title" value="{{ $service->meta_title }}">
                                            @error('meta_title')
                                                <span class="text-danger">{{ $message }}</span>
                                            @enderror
                                        </div>
                                        <div class="mb-2">
                                            ...
                                            <textarea rows="4" name="meta_description" placeholder="Meta Description"
                                                class="form-control @error('meta_description') is-invalid @enderror" id="meta_description">{{ $service->meta_description }}</textarea>
                                        ...
                                        <div class="mb-2">
                                            ...
                                            <textarea rows="4" name="meta_keywords" placeholder="Meta Keywords"
                                                class="form-control @error('meta_keywords') is-invalid @enderror" id="meta_keywords">{{ $service->meta_keywords }}</textarea>
                                            @error('meta_keywords')
                                                <span class="text-danger">{{ $message }}</span>
                                            @enderror
                                        </div>
                                        <div class="mb-2">
                                            ...
                                            <textarea rows="4" name="meta_scripts" placeholder="Meta Scripts"
                                                class="form-control @error('meta_scripts') is-invalid @enderror" id="meta_scripts">{{ $service->meta_scripts }}</textarea>
                                            @error('meta_scripts')
                                                <span class="text-danger">{{ $message }}</span>
                                            @enderror
                                        </div>
