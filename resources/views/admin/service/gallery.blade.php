            ...
            <div class="row">
                                                    ...
                                                    <div class="dropdown">
                                                        ...
                                                        <ul class="dropdown-menu">
                                                            <li><a class="dropdown-item"
                                                                    href="{{ route('gallery.edit', [$service, $item->id]) }}"><i
                                                                        class="bx bxs-edit-alt"></i> Edit</a></li>
                                                            <li>
                                                                <form
                                                                    action="{{ route('gallery.destroy', [$service, $item->id]) }}"
                                                                    method="POST">
                                                                    @csrf
                                                                    @method('DELETE')
                                                            ...
                                                            <li>
                                                                <a href="{{ route('service.gallery.status.update', [$service, $item->id]) }}"
                ...
                <div class="col-lg-4">
                    <div class="card">
                        @if ($gallery)
                            <div class="card-body">
                                <form class="row g-2" action="{{ route('gallery.update', [$service, $gallery->id]) }}"
                                    ...
                                    <div class="text-end">
                                        <a href="{{ route('gallery.index', $service) }}"
                        ...
                        @else
                            <div class="card-body">
                                <form class="row g-2" action="{{ route('gallery.store', $service) }}" method="POST"
