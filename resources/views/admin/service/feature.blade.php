            ...
            <div class="row">
                                                    ...
                                                    <div class="dropdown">
                                                        ...
                                                        <ul class="dropdown-menu">
                                                            <li><a class="dropdown-item"
                                                                    href="{{ route('feature.edit', [$service, $item->id]) }}"><i
                                                                        class="bx bxs-edit-alt"></i> Edit</a></li>
                                                            <li>
                                                                <form
                                                                    action="{{ route('feature.destroy', [$service, $item->id]) }}"
                                                                    method="POST">
                                                                    @csrf
                                                                    @method('DELETE')
                                                            ...
                                                            <li>
                                                                <a href="{{ route('feature.status.update', [$service, $item->id]) }}"
                ...
                <div class="col-lg-4">
                    <div class="card">
                        @if ($feature)
                            <div class="card-body">
                                <form class="row g-2" action="{{ route('feature.update', [$service, $feature->id]) }}"
                                    ...
                                    <div class="col-12 p-2 text-center">
                                        <div>
                                            @if ($feature->image)
                                                <img id="profileImage" src="{{ asset($feature->image) }}" alt="image"
                                                    width="50%">
                                            @else
                                    ...
                                    <div class="col-12">
                                        ...
                                        {{-- <textarea name="short_description" id="" cols="30" rows="5" class="form-control">{{ $feature->short_description }}</textarea> --}}
                                    ...
                                    <div class="col-12">
                                        ...
                                        <select name="is_active" id="" class="form-control" required>
                                            <option {{ $feature->is_active == 1 ? 'selected' : '' }} value="1">Active
                                            </option>
                                            <option {{ $feature->is_active == 0 ? 'selected' : '' }} value="0">
                                                Inactive</option>
                                        </select>
                                        @error('is_active')
                                            <span class="text-danger">{{ $message }}</span>
                                    ...
                                    <div class="text-end">
                                        <a href="{{ route('feature.index', $service) }}"
                        ...
                        @else
                            <div class="card-body">
                                <form class="row g-2" action="{{ route('feature.store', $service) }}" method="POST"
