            ...
            <div class="row">
                                                    ...
                                                    <div class="dropdown">
                                                        ...
                                                        <ul class="dropdown-menu">
                                                            <li><a class="dropdown-item"
                                                                    href="{{ route('description.edit', [$service, $item->id]) }}"><i
                                                                        class="bx bxs-edit-alt"></i> Edit</a></li>
                                                            <li>
                                                                <form
                                                                    action="{{ route('description.destroy', [$service, $item->id]) }}"
                                                                    method="POST">
                                                                    @csrf
                                                                    @method('DELETE')
                                                            ...
                                                            <li>
                                                                <a href="{{ route('service.description.status.update', [$service, $item->id]) }}"
                ...
                <div class="col-lg-6">
                    <div class="card">
                        @if ($description)
                            <div class="card-body">
                                <form class="row g-2" action="{{ route('description.update', [$service, $description->id]) }}"
                                    ...
                                    <div class="col-12 p-2 text-center">
                                        <div>
                                            @if ($description->image)
                                                <img id="profileImage" src="{{ asset($description->image) }}" alt="image"
                                                    width="50%">
                                            @else
                                    ...
                                    <div class="col-12">
                                        ...
                                        <div class="service-description-quill-editor-full"
                                            style="height: 300px;padding-top: 20px;">{!!$description->description!!}</div>
                                    ...
                                    <div class="col-12">
                                        ...
                                        <select name="is_active" id="" class="form-control" required>
                                            <option {{ $description->is_active == 1 ? 'selected' : '' }} value="1">Active
                                            </option>
                                            <option {{ $description->is_active == 0 ? 'selected' : '' }} value="0">
                                                Inactive</option>
                                        </select>
                                        @error('is_active')
                                            <span class="text-danger">{{ $message }}</span>
                                    ...
                                    <div class="text-end">
                                        <a href="{{ route('description.index', $service) }}"
                        ...
                        @else
                            <div class="card-body">
                                <form class="row g-2" action="{{ route('description.store', $service) }}" method="POST"
