...
@section('main')
    <main id="main" class="main">
        ...
        <section class="section">
            <div class="row">
                <div class="col-lg-12">
                    <form action="{{ route('service.store') }}" method="POST" id="serviceAreaForm" enctype="multipart/form-data">
                        @csrf
                        <div class="card">
                            <div class="card-body">
                                <div class="row py-4">
                                        ...
                                        <div class="mb-2">
                                          ...
                                          <div class="mb-2">
                                            ...
                                            <textarea rows="4" name="meta_scripts" placeholder="Meta Scripts"
                                                class="form-control @error('meta_scripts') is-invalid @enderror" id="meta_scripts">{{old('meta_scripts')}}</textarea>
                                            @error('meta_scripts')
                                                <span class="text-danger">{{ $message }}</span>
                                            @enderror
                                        </div>
