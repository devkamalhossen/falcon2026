            ...
            <div class="d-flex align-items-center justify-content-between flex-wrap">
                <nav>
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item">Benefits</li>
            ...
            <div class="row">
                                                    ...
                                                    <div class="dropdown">
                                                        ...
                                                        <ul class="dropdown-menu">
                                                            <li><a class="dropdown-item"
                                                                    href="{{ route('benefit.edit', [$service, $item->id]) }}"><i
                                                                        class="bx bxs-edit-alt"></i> Edit</a></li>
                                                            <li>
                                                                <form
                                                                    action="{{ route('benefit.destroy', [$service, $item->id]) }}"
                                                                    method="POST">
                                                                    @csrf
                                                                    @method('DELETE')
                                                            ...
                                                            <li>
                                                                <a href="{{ route('benefit.status.update', [$service, $item->id]) }}"
                ...
                <div class="col-lg-4">
                    <div class="card">
                        @if ($benefit)
                            <div class="card-body">
                                <form class="row g-2" action="{{ route('benefit.update', [$service, $benefit->id]) }}"
                                    method="POST" enctype="multipart/form-data" id="serviceBenefitForm">
                                    @csrf
                                    @method('PUT')
                                    ...
                                    <div class="col-12 p-2 text-center">
                                        <div>
                                            @if ($benefit->image)
                                                <img id="profileImage" src="{{ asset($benefit->image) }}" alt="image"
                                                    width="50%">
                                            @else
                                    ...
                                    <div class="col-12">
                                        ...
                                        {{-- <textarea name="short_description" id="" cols="30" rows="5" class="form-control">{{ $benefit->short_description }}</textarea> --}}
                                        <div style="height: 300px;padding-bottom: 60px;">
                                            <div class="quill-editor-service-benefit-full">
                                    ...
                                    <div class="col-12">
                                        ...
                                        <select name="is_active" id="" class="form-control" required>
                                            <option {{ $benefit->is_active == 1 ? 'selected' : '' }} value="1">Active
                                            </option>
                                            <option {{ $benefit->is_active == 0 ? 'selected' : '' }} value="0">
                                                Inactive</option>
                                        </select>
                                        @error('is_active')
                                            <span class="text-danger">{{ $message }}</span>
                                    ...
                                    <div class="text-end">
                                        <a href="{{ route('benefit.index', $service) }}"
                        ...
                        @else
                            <div class="card-body">
                                <form class="row g-2" action="{{ route('benefit.store', $service) }}" method="POST"
                                    enctype="multipart/form-data" id="serviceBenefitForm">
                                    @csrf
                                    <div class="col-12 p-2 text-center">
                                        <div>
                                            <img id="profileImage" src="{{ asset('admin/assets/img/400X290.svg') }}"
                                    ...
                                    <div class="col-12">
                                        ...
                                        <div style="height: 300px;padding-bottom: 60px;">
                                            <div class="quill-editor-service-benefit-full"></div>
                                            <input type="hidden" name="short_description" id="short_description"
                                                value="{{ old('short_description') }}" />
                                        </div>
                                        @error('short_description')
