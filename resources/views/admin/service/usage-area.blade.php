            ...
            <div class="d-flex align-items-center justify-content-between flex-wrap">
                <nav>
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item">Usage Area</li>
                        <li class="breadcrumb-item active">Usage Area</li>
                    </ol>
                </nav>
                                            ...
                                            <td>
                                                @if ($item->image)
                                                    <img src="{{ asset($item->image) }}" class="rounded" alt=""
                                                        width="100">
                                                @else
                                                    <img src="{{ asset('admin/assets/img/placeholder.png') }}"
                                                    ...
                                                    <div class="dropdown">
                                                        ...
                                                        <ul class="dropdown-menu">
                                                            <li><a class="dropdown-item"
                                                                    href="{{ route('usage-area.edit', [$service, $item->id]) }}"><i
                                                                        class="bx bxs-edit-alt"></i> Edit</a></li>
                                                            <li>
                                                                <form
                                                                    action="{{ route('usage-area.destroy', [$service, $item->id]) }}"
                                                                    method="POST">
                                                                    @csrf
                                                                    @method('DELETE')
                                                            ...
                                                            <li>
                                                                <a href="{{ route('usage-area.status.update', [$service, $item->id]) }}"
                ...
                <div class="col-lg-4">
                    <div class="card">
                        @if ($usage_area)
                            <div class="card-body">
                                <form class="row g-2"
                                    action="{{ route('usage-area.update', [$service, $usage_area->id]) }}" method="POST"
                                    enctype="multipart/form-data" id="serviceUsageAreaForm">
                                    @csrf
                                    @method('PUT')
                                    ...
                                    <div class="col-12 p-2 text-center">
                                        <div>
                                            @if ($usage_area->image)
                                                <img id="profileImage" src="{{ asset($usage_area->image) }}" alt="image"
                                                    width="50%">
                                            @else
                                                <img id="profileImage" src="{{ asset('admin/assets/img/400X290.svg') }}"
                                                    alt="image" width="50%">
                                            @endif
                                            <div class="pt-2">
                                                <!-- Hidden File Input -->
                                    ...
                                    <div class="col-12">
                                        ...
                                        {{-- <textarea name="short_description" id="" cols="30" rows="5" class="form-control">{{ $usage_area->short_description }}</textarea> --}}
                                        <div style="height: 300px;padding-bottom: 60px;">
                                            <div class="quill-editor-service-usage_area-full">
                                                {!! $usage_area?->short_description !!}
                                            </div>
                                    ...
                                    <div class="col-12">
                                        ...
                                        <select name="is_active" id="" class="form-control" required>
                                            <option {{ $usage_area->is_active == 1 ? 'selected' : '' }} value="1">
                                                Active
                                            </option>
                                            <option {{ $usage_area->is_active == 0 ? 'selected' : '' }} value="0">
                                                Inactive</option>
                                        </select>
                                        @error('is_active')
                                            <span class="text-danger">{{ $message }}</span>
                                    ...
                                    <div class="text-end">
                                        <a href="{{ route('usage-area.index', $service) }}"
                        ...
                        @else
                            <div class="card-body">
                                <form class="row g-2" action="{{ route('usage-area.store', $service) }}" method="POST"
                                    enctype="multipart/form-data" id="serviceUsageAreaForm">
                                    @csrf
                                    <div class="col-12 p-2 text-center">
                                        <div>
                                    ...
                                    <div class="col-12">
                                        ...
                                        {{-- <textarea name="short_description" id="" cols="30" rows="5" class="form-control"
                                         ...
                                         <div style="height: 300px;padding-bottom: 60px;">
                                            <div class="quill-editor-service-usage_area-full"></div>
                                            <input type="hidden" name="short_description" id="short_description"
                                                value="{{ old('short_description') }}" />
                                        </div>
    ...
    <script>
        ...
        document.getElementById('removeImageButton').addEventListener('click', function(e) {
            ...
            document.getElementById('profileImage').setAttribute('src',
                '{{ asset('admin/assets/img/400X290.svg') }}');
        });
    </script>
@endsection
