            ...
            <div class="row">
                                                    ...
                                                    <div class="dropdown">
                                                        ...
                                                        <ul class="dropdown-menu">
                                                            <li><a class="dropdown-item"
                                                                    href="{{ route('business.edit', $item->id) }}"><i
                                                                        class="bx bxs-edit-alt"></i> Edit</a></li>
                                                            <li>
                                                                <form
                                                                    action="{{ route('business.destroy', $item->id) }}"
                                                                    method="POST">
                                                                    @csrf
                                                                    @method('DELETE')
                                                            ...
                                                            <li>
                                                                <a href="{{ route('business.status.update', $item->id) }}"
                ...
                <div class="col-lg-4">
                    <div class="card">
                        @if ($business)
                            <div class="card-body">
                                <form class="row g-2" action="{{ route('business.update', $business->id) }}"
                                    ...
                                    <div class="col-12">
                                        ...
                                        <select name="is_active" id="" class="form-control" required>
                                            <option {{ $business->is_active == 1 ? 'selected' : '' }} value="1">Active
                                            </option>
                                            <option {{ $business->is_active == 0 ? 'selected' : '' }} value="0">
                                                Inactive
                                            </option>
                                        </select>
                                        @error('is_active')
                        ...
                        @else
                            <div class="card-body">
                                <form class="row g-2" action="{{ route('business.store') }}" method="POST" enctype="multipart/form-data">
                                    @csrf
                                    <div class="mb-2">
                                            <label for="category_id" class="form-label">Category</label>
                                            <select name="category_id" id="" class="form-control" required>
