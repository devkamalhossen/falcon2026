...
@section('main')
    <main id="main" class="main">
        ...
        <section class="section">
            <div class="row">
                <div class="col-lg-12">
                    <form action="{{ route('project.update', $project->id) }}" method="POST" id="serviceAreaForm"
                            ...
                            <div class="card-body">
                                <div class="row py-4">
                                    <div class="col-6 col-lg-6 col-md-6">
                                        ...
                                        <div class="mb-2">
                                            ...
                                            <select name="service_id" id="" class="form-control" required>
                                                ...
                                                @foreach ($services as $service)
                                                    <option {{ $project->service_id == $service->id ? 'selected' : '' }}
                                        ...
                                        <div class="mb-2">
                                            ...
                                            <select name="is_active" id="" class="form-control" required>
                                                <option {{ $project->is_active == 1 ? 'selected' : '' }} value="1">
                                                    Active</option>
                                                <option {{ $project->is_active == 0 ? 'selected' : '' }} value="0">
                                                    Inactive</option>
                                            </select>
                                            @error('is_active')
                                                <span class="text-danger">{{ $message }}</span>
                                        ...
                                        <div class="mb-2">
                                            ...
                                            <select name="status" id="" class="form-control" required>
                                                ...
                                                <option {{ $project->status == 2 ? 'selected' : '' }} value="2">
                                                    Ongoing</option>
                                                <option {{ $project->status == 3 ? 'selected' : '' }} value="3">
                                                    Completed</option>
                                            </select>
                                            @error('status')
                                                <span class="text-danger">{{ $message }}</span>
                                        ...
                                        <div class="mb-2">
                                            ...
                                            <select name="is_featured" id="" class="form-control" required>
                                                <option {{ $project->is_featured == 1 ? 'selected' : '' }} value="1">
                                                    Featured</option>
                                                <option {{ $project->is_featured == 0 ? 'selected' : '' }} value="0">
                                                    Not Featured</option>
                                            </select>
                                            @error('is_featured')
                                                <span class="text-danger">{{ $message }}</span>
                                    ...
                                    <div class="col-6 p-2 text-center">
                                        <div>
                                            @if ($project->image)
                                                <img id="profileImage" src="{{ asset($project->image) }}" alt="Profile"
                                                    width="50%">
                                            @else
                        ...
                        <div class="card">
                            <div class="card-body" style="height: 400px;padding-top: 20px;">
                                <div class="service-area-quill-editor-full" style="border: none;">{!! $project->description !!}
                                </div>
                                    ...
                                    <div class="col-12 col-lg-12 col-md-12">
                                        <div class="mb-2">
                                            ...
                                            <input type="text" name="meta_title" placeholder="Meta Title"
                                                ...
                                                id="meta_title" value="{{ $project->meta_title }}">
                                            @error('meta_title')
                                                <span class="text-danger">{{ $message }}</span>
                                            @enderror
                                        </div>
                                        <div class="mb-2">
                                            ...
                                            <textarea rows="4" name="meta_description" placeholder="Meta Description"
                                                class="form-control @error('meta_description') is-invalid @enderror" id="meta_description">{{ $project->meta_description }}</textarea>
                                        ...
                                        <div class="mb-2">
                                            ...
                                            <textarea rows="4" name="meta_keywords" placeholder="Meta Keywords"
                                                class="form-control @error('meta_keywords') is-invalid @enderror" id="meta_keywords">{{ $project->meta_keywords }}</textarea>
                                            @error('meta_keywords')
                                                <span class="text-danger">{{ $message }}</span>
                                            @enderror
                                        </div>
