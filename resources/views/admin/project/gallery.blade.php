    ...
    <main id="main" class="main">
        ...
        <div class="pagetitle">
            ...
            <div class="d-flex align-items-center justify-content-between flex-wrap">
                ...
                <a href="{{ route('project.index') }}" class="btn btn-sm btn-primary">Go Back</a>
            </div>
        </div>
            ...
            <div class="row">
                                                    ...
                                                    <div class="dropdown">
                                                        ...
                                                        <ul class="dropdown-menu">
                                                            <li><a class="dropdown-item"
                                                                    href="{{ route('pgallery.edit', [$project, $item->id]) }}"><i
                                                                        class="bx bxs-edit-alt"></i> Edit</a></li>
                                                            <li>
                                                                <form
                                                                    action="{{ route('pgallery.destroy', [$project, $item->id]) }}"
                                                                    method="POST">
                                                                    @csrf
                                                                    @method('DELETE')
                                                            ...
                                                            <li>
                                                                <a href="{{ route('project.pgallery.status.update', [$project, $item->id]) }}"
                ...
                <div class="col-lg-4">
                    <div class="card">
                        @if ($pgallery)
                            <div class="card-body">
                                <form class="row g-2" action="{{ route('pgallery.update', [$project, $pgallery->id]) }}"
                                    ...
                                    <div class="col-12 p-2 text-center">
                                        <div>
                                            @if ($pgallery->image)
                                                <img id="profileImage" src="{{ asset($pgallery->image) }}" alt="image"
                                                    width="50%">
                                            @else
                                    ...
                                    <div class="col-12">
                                        ...
                                        <select name="is_active" id="" class="form-control" required>
                                            <option {{ $pgallery->is_active == 1 ? 'selected' : '' }} value="1">Active
                                            </option>
                                            <option {{ $pgallery->is_active == 0 ? 'selected' : '' }} value="0">
                                                Inactive</option>
                                        </select>
                                        @error('is_active')
                                            <span class="text-danger">{{ $message }}</span>
                                    ...
                                    <div class="text-end">
                                        <a href="{{ route('pgallery.index', $project) }}"
                        ...
                        @else
                            <div class="card-body">
                                <form class="row g-2" action="{{ route('pgallery.store', $project) }}" method="POST"
