...
@section('title', 'Service Area Create')

@section('main')
    <main id="main" class="main">

        <div class="pagetitle">
            <h1>Service Area Create</h1>
        ...
        <section class="section">
            <div class="row">
                <div class="col-lg-12">
                    <form action="{{ route('service-area.store') }}" method="POST" id="serviceAreaForm" enctype="multipart/form-data">
                        @csrf
                        <div class="card">
                            <div class="card-body">
                                <div class="row py-4">
                                    <div class="col-6 col-lg-6 col-md-6">
                                        <div class="mb-2">
                                            ...
                                            <input type="text" name="area_name" placeholder="Area Name"
                                                class="form-control @error('area_name') is-invalid @enderror" id="area_name" value="{{old('area_name')}}">
                                            @error('area_name')
                                        ...
                                        <div class="mb-2">
                                            ...
                                            <input type="text" name="area_slug" placeholder="Area Slug"
                                                class="form-control @error('area_slug') is-invalid @enderror" id="area_slug" value="{{old('area_slug')}}">
                                            @error('area_slug')
                                                <span class="text-danger">{{ $message }}</span>
                                            @enderror
                                        </div>
