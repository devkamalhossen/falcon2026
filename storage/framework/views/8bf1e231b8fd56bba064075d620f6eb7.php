...
<?php $__env->startSection('main'); ?>
    <main id="main" class="main">
        ...
        <section class="section">
            <div class="row">
                <div class="col-lg-12">
                    <form action="<?php echo e(route('service.update', $service->id)); ?>" method="POST" id="serviceAreaForm"
                                        ...
                                        <div class="mb-2">
                                            ...
                                            <select name="service_category_id" id="" class="form-control" required>
                                                ...
                                                <?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <option
                                                        <?php echo e($service->service_category_id == $category->id ? 'selected' : ''); ?>
...
unset($__errorArgs, $__bag); ?>
                                        ...
                                        <div class="mb-2">
                                            ...
                                            <select name="is_active" id="" class="form-control" required>
                                                <option <?php echo e($service->is_active == 1 ? 'selected' : ''); ?> value="1">
                                                    Active</option>
                                                <option <?php echo e($service->is_active == 0 ? 'selected' : ''); ?> value="0">
                                                    Inactive</option>
                                            </select>
...
unset($__errorArgs, $__bag); ?>
                                    ...
                                    <div class="col-6 p-2 text-center">
                                        <div>
                                            <img id="profileImage" src="<?php echo e(asset($service?->image)); ?>" alt="Profile"
                                                width="50%">
                                            <div class="pt-2">
                                                <!-- Hidden File Input -->
                                                ...
                                                <div>
                                                    <?php if($service->video): ?>
                                                        <video id="videoTag" width="400" height="260" controls
                                                            autoplay>
                                                            <source src="<?php echo e(asset($service->video)); ?>" type="video/mp4">
...
unset($__errorArgs, $__bag); ?>"
                                                id="meta_title" value="<?php echo e($service->meta_title); ?>">
...
unset($__errorArgs, $__bag); ?>" id="meta_description"><?php echo e($service->meta_description); ?></textarea>
...
unset($__errorArgs, $__bag); ?>" id="meta_keywords"><?php echo e($service->meta_keywords); ?></textarea>
...
unset($__errorArgs, $__bag); ?>" id="meta_scripts"><?php echo e($service->meta_scripts); ?></textarea>
...
<?php echo $__env->make('admin.layouts.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\falcon2026\resources\views/admin/service/edit.blade.php ENDPATH**/ ?>