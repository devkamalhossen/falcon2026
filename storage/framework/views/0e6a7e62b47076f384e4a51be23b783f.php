            ...
            <div class="d-flex align-items-center justify-content-between flex-wrap">
                <nav>
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item">Certificationss</li>
                                                    ...
                                                    <div class="dropdown">
                                                        ...
                                                        <ul class="dropdown-menu">
                                                            <li><a class="dropdown-item"
                                                                    href="<?php echo e(route('certification.edit', $item->id)); ?>"><i
                                                                        class="bx bxs-edit-alt"></i> Edit</a></li>
                                                            <li>
                                                                <form action="<?php echo e(route('certification.destroy', $item->id)); ?>"
                                                                    method="POST">
                                                                    <?php echo csrf_field(); ?>
                                                            ...
                                                            <li>
                                                                <a href="<?php echo e(route('certification.status.update', $item->id)); ?>"
                ...
                <div class="col-lg-4">
                    <div class="card">
                        <?php if($certification): ?>
                            <div class="card-body">
                                <form class="row g-2" action="<?php echo e(route('certification.update', $certification->id)); ?>" method="POST"
                                    enctype="multipart/form-data">
                                    <?php echo csrf_field(); ?>
                                    <?php echo method_field('PUT'); ?>
                                    <div class="col-12 p-2 text-center">
                                        <div>
                                            <img id="profileImage" src="<?php echo e(asset($certification->image)); ?>"
                                                alt=" Iimage" width="30%">
                                            <div class="pt-2">
                                                <!-- Hidden File Input -->
...
unset($__errorArgs, $__bag); ?>
                                    ...
                                    <div class="col-12 col-lg-6 col-md-6">
                                        ...
                                        <select name="is_active" id="" class="form-control" required>
                                            <option <?php echo e($certification->is_active == 1 ? 'selected':''); ?> value="1">Active</option>
                                            <option <?php echo e($certification->is_active == 0 ? 'selected':''); ?> value="0">Inactive</option>
                                        </select>
...
unset($__errorArgs, $__bag); ?>
                                    ...
                                    <div class="text-end">
                                        <a href="<?php echo e(route('certification.index')); ?>" class="btn btn-sm btn-danger">Cancel</a>
                        ...
                        <?php else: ?>
                            <div class="card-body">
                                <form class="row g-2" action="<?php echo e(route('certification.store')); ?>" method="POST"
                                    enctype="multipart/form-data">
                                    <?php echo csrf_field(); ?>
                                    <div class="col-12 p-2 text-center">
                                        <div>
                                            <img id="profileImage" src="<?php echo e(asset('admin/assets/img/400X500.svg')); ?>"
                                                alt="Image" width="30%">
                                            <div class="pt-2">
                                                <!-- Hidden File Input -->
                                                <input type="file" name="image" id="profileImageInput"
...
<?php echo $__env->make('admin.layouts.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/falconso/public_html/resources/views/admin/certifications/index.blade.php ENDPATH**/ ?>