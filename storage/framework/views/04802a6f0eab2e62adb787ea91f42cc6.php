...
<main class="grid min-h-screen place-items-center bg-[#FFFAF4] px-6 py-24 sm:py-32 lg:px-8 relative">
    ...
    <div class="text-center">
        <h1 class="mt-4 text-5xl font-semibold tracking-tight text-balance text-primary sm:text-7xl">404</h1>
        <p class="mt-6 text-lg font-normal text-pretty text-slate-500 sm:text-xl/8 max-w-md">Sorry, the page you’re looking for doesn’t exist or has been moved.</p>
        <div class="mt-10 flex items-center justify-center gap-x-6">
        <a href="<?php echo e(url()->previous()); ?>" type="submit"
...
</html><?php /**PATH /home/falconso/public_html/resources/views/errors/404.blade.php ENDPATH**/ ?>