            ...
            <div class="d-flex align-items-center justify-content-between flex-wrap">
                <nav>
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">Client Page Content</li>
                    </ol>
                </nav>
            </div>
        </div>
            ...
            <div class="row">
                ...
                <div class="col-lg-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form class="row g-2" action="<?php echo e(route('page.client.update', $pageData?->id)); ?>" method="POST"
...
<?php echo $__env->make('admin.layouts.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/falconso/public_html/resources/views/admin/pages/client.blade.php ENDPATH**/ ?>