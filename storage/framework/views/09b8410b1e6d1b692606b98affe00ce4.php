<?php $__env->startSection('title', 'Team Page'); ?>
            ...
            <div class="d-flex align-items-center justify-content-between flex-wrap">
                <nav>
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">Team Page Content</li>
                    </ol>
                </nav>
            </div>
        </div>
            ...
            <div class="row">
                ...
                <div class="col-lg-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form class="row g-2" action="<?php echo e(route('page.team.update', $pageData?->id)); ?>" method="POST"
                                ...
                                <div class="col-6 p-2 text-center">
                                    <div>
                                        <img id="profileImage2"
                                            src="<?php echo e(asset($pageData?->team_image ? $pageData?->team_image : 'admin/assets/img/1920X1080.svg')); ?>"
                                            alt="Image" width="50%">
                                        <div class="pt-2">
                                            <!-- Hidden File Input -->
                                            <input type="file" name="team_image" id="profileImageInput2"
                                                style="display: none;">

                                            <!-- Upload Button -->
                                            <a href="#" class="btn btn-primary btn-sm" title="Upload image"
                                                id="uploadImageButton2">
                                                <i class="bi bi-upload"></i>
                                            </a>

                                            <!-- Remove Button -->
                                            <a href="#" class="btn btn-danger btn-sm" title="Remove image"
                                                id="removeImageButton2">
                                                <i class="bi bi-trash"></i>
                                            </a>
                                        </div>
...
<?php $__env->startSection('scripts'); ?>
    <script>
        ...
        // Handle Upload Button Click
        document.getElementById('uploadImageButton2').addEventListener('click', function(e) {
            e.preventDefault();
            document.getElementById('profileImageInput2').click();
        });

        // Handle Image File Selection
        document.getElementById('profileImageInput2').addEventListener('change', function() {
            const file = this.files[0];
            if (file) {
                const reader = new FileReader();
                reader.onload = function(e) {
                    document.getElementById('profileImage2').setAttribute('src', e.target.result);
                }
                reader.readAsDataURL(file);
            }
        });
        ...
        // Handle Remove Button Click
        document.getElementById('removeImageButton2').addEventListener('click', function(e) {
            e.preventDefault();
            document.getElementById('profileImage2').setAttribute('src',
                '<?php echo e(asset('admin/assets/img/1920X1080.svg')); ?>');
        });
    </script>
<?php $__env->stopSection(); ?>

<?php echo $__env->make('admin.layouts.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/falconso/public_html/resources/views/admin/pages/team.blade.php ENDPATH**/ ?>