<?php $__env->startSection('title', 'Our Business Page'); ?>
...
<?php $__env->startSection('main'); ?>
    <main id="main" class="main">
        ...
        <div class="pagetitle">
            <h1>Our Business Page</h1>
            <div class="d-flex align-items-center justify-content-between flex-wrap">
                <nav>
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="<?php echo e(route('admin.dashboard')); ?>">Dashboard</a></li>
                        <li class="breadcrumb-item">Our Businesss</li>
                        <li class="breadcrumb-item active">Our Business Page Content</li>
                    </ol>
                </nav>
            </div>
        </div>
            ...
            <div class="row">
                ...
                <div class="col-lg-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form class="row g-2" action="<?php echo e(route('page.our.business.update', $pageData?->id)); ?>" method="POST"
...
<?php echo $__env->make('admin.layouts.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/falconso/public_html/resources/views/admin/pages/our-business.blade.php ENDPATH**/ ?>