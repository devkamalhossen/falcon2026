<?php $__env->startSection('title', 'Certification Page'); ?>
            ...
            <div class="d-flex align-items-center justify-content-between flex-wrap">
                <nav>
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item">Certifications</li>
                        <li class="breadcrumb-item active">Certification Page Content</li>
                    </ol>
                </nav>
            </div>
        </div>
            ...
            <div class="row">
                ...
                <div class="col-lg-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form class="row g-2" action="<?php echo e(route('page.certificate.update', $pageData?->id)); ?>" method="POST"
...
<?php echo $__env->make('admin.layouts.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/falconso/public_html/resources/views/admin/pages/certification.blade.php ENDPATH**/ ?>