...
<?php $__env->startSection('main'); ?>
    <main id="main" class="main">
        ...
        <section class="section">
            <div class="row">
                <div class="col-lg-12">
                    <form action="<?php echo e(route('blog.store')); ?>" method="POST" id="blogForm" enctype="multipart/form-data">
                        <?php echo csrf_field(); ?>
                        <div class="card">
                            <div class="card-body">
                                <div class="row py-4">
...
unset($__errorArgs, $__bag); ?>" id="blog_excerpt"><?php echo e(old('blog_excerpt')); ?></textarea>
                        ...
                        <div class="card">
                            <div class="card-body" >
                                ...
                                <input type="hidden" name="post_content" id="post_content"
                                    value="<?php echo e(old('post_content')); ?>" />
                            </div>
                        </div>
                        <div class="card">
                            <div class="card-body">
...
<?php echo $__env->make('admin.layouts.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/falconso/public_html/resources/views/admin/blog/create.blade.php ENDPATH**/ ?>