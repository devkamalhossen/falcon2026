            ...
            <div class="row">
                                                    ...
                                                    <div class="dropdown">
                                                        ...
                                                        <ul class="dropdown-menu">
                                                            <li><a class="dropdown-item"
                                                                    href="<?php echo e(route('feature.edit', [$service, $item->id])); ?>"><i
                                                                        class="bx bxs-edit-alt"></i> Edit</a></li>
                                                            <li>
                                                                <form
                                                                    action="<?php echo e(route('feature.destroy', [$service, $item->id])); ?>"
                                                                    method="POST">
                                                                    <?php echo csrf_field(); ?>
                                                            ...
                                                            <li>
                                                                <a href="<?php echo e(route('feature.status.update', [$service, $item->id])); ?>"
                ...
                <div class="col-lg-4">
                    <div class="card">
                        <?php if($feature): ?>
                            <div class="card-body">
                                <form class="row g-2" action="<?php echo e(route('feature.update', [$service, $feature->id])); ?>"
                                    method="POST" enctype="multipart/form-data" id="serviceFeatureForm">
                                    <?php echo csrf_field(); ?>
                                    <?php echo method_field('PUT'); ?>
                                    <div class="col-12 p-2 text-center">
                                        <div>
                                            <?php if($feature->image): ?>
                                                <img id="profileImage" src="<?php echo e(asset($feature->image)); ?>" alt="image"
                                                    width="50%">
                                            <?php else: ?>
                                                <img id="profileImage" src="<?php echo e(asset('admin/assets/img/400X290.svg')); ?>"
                                                    alt="image" width="50%">
                                            <?php endif; ?>
                                            <div class="pt-2">
                                                <!-- Hidden File Input -->
...
unset($__errorArgs, $__bag); ?>
                                    ...
                                    <div class="col-12">
                                        ...
                                        <div style="height: 300px;padding-bottom: 60px;">
                                            <div class="quill-editor-service-feature-full">
...
unset($__errorArgs, $__bag); ?>
                                    ...
                                    <div class="col-12">
                                        ...
                                        <select name="is_active" id="" class="form-control" required>
                                            <option <?php echo e($feature->is_active == 1 ? 'selected' : ''); ?> value="1">Active
                                            </option>
                                            <option <?php echo e($feature->is_active == 0 ? 'selected' : ''); ?> value="0">
                                                Inactive</option>
                                        </select>
...
unset($__errorArgs, $__bag); ?>
                                    ...
                                    <div class="text-end">
                                        <a href="<?php echo e(route('feature.index', $service)); ?>"
                        ...
                        <?php else: ?>
                            <div class="card-body">
                                <form class="row g-2" action="<?php echo e(route('feature.store', $service)); ?>" method="POST"
                                    enctype="multipart/form-data" id="serviceFeatureForm">
                                    <?php echo csrf_field(); ?>
                                    <div class="col-12 p-2 text-center">
                                        <div>
                                            <img id="profileImage" src="<?php echo e(asset('admin/assets/img/400X290.svg')); ?>"
...
unset($__errorArgs, $__bag); ?>
                                    ...
                                    <div class="col-12">
                                        ...
                                        <div style="height: 300px;padding-bottom: 60px;">
                                            <div class="quill-editor-service-feature-full"></div>
                                            <input type="hidden" name="short_description" id="short_description"
                                                value="<?php echo e(old('short_description')); ?>" />
                                        </div>
    ...
    <script>
        ...
        document.getElementById('removeImageButton').addEventListener('click', function(e) {
            ...
            document.getElementById('profileImage').setAttribute('src',
                '<?php echo e(asset('admin/assets/img/400X290.svg')); ?>');
        });
    </script>
<?php $__env->stopSection(); ?>

<?php echo $__env->make('admin.layouts.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/falconso/public_html/resources/views/admin/service/feature.blade.php ENDPATH**/ ?>