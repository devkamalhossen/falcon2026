...
<main class="grid min-h-screen place-items-center bg-[#FFFAF4] px-6 py-24 sm:py-32 lg:px-8 relative">
    ...
    <div class="text-center">
        <h1 class="mt-4 text-5xl font-semibold tracking-tight text-balance text-primary sm:text-7xl">403</h1>
        <p class="mt-6 text-lg font-normal text-pretty text-slate-500 sm:text-xl/8 max-w-md">You don’t have permission to view this page.</p>
...
</html><?php /**PATH /home/falconso/public_html/resources/views/errors/403.blade.php ENDPATH**/ ?>