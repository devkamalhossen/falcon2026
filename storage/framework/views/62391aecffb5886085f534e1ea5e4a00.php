...
<?php $__env->startSection('main'); ?>
    <main id="main" class="main">
        ...
        <section class="section">
            <div class="row">
                <div class="col-lg-12">
                    <form action="<?php echo e(route('project.update', $project->id)); ?>" method="POST" id="serviceAreaForm"
...
unset($__errorArgs, $__bag); ?>" id="motto"
                                                value="<?php echo e($project->motto); ?>">
...
unset($__errorArgs, $__bag); ?>" id="video_id"
                                                value="<?php echo e($project->video_id); ?>">
                                        ...
                                        <div class="mb-2">
                                            ...
                                            <select name="service_id" id="" class="form-control" required>
                                                ...
                                                <?php $__currentLoopData = $services; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $service): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <option <?php echo e($project->service_id == $service->id ? 'selected' : ''); ?>

                                                        value="<?php echo e($service->id); ?>"><?php echo e($service->title); ?></option>
...
unset($__errorArgs, $__bag); ?>
                                        ...
                                        <div class="mb-2">
                                            ...
                                            <select name="is_active" id="" class="form-control" required>
                                                <option <?php echo e($project->is_active == 1 ? 'selected' : ''); ?> value="1">
                                                    Active</option>
                                                <option <?php echo e($project->is_active == 0 ? 'selected' : ''); ?> value="0">
                                                    Inactive</option>
                                            </select>
                                        ...
                                        <div class="mb-2">
                                            ...
                                            <select name="status" id="" class="form-control" required>
                                                <option <?php echo e($project->status == 1 ? 'selected' : ''); ?> value="1">
                                                    Upcoming</option>
                                                <option <?php echo e($project->status == 2 ? 'selected' : ''); ?> value="2">
                                                    Ongoing</option>
                                                <option <?php echo e($project->status == 3 ? 'selected' : ''); ?> value="3">
                                                    Completed</option>
                                            </select>
...
unset($__errorArgs, $__bag); ?>
                                        ...
                                        <div class="mb-2">
                                            ...
                                            <select name="is_featured" id="" class="form-control" required>
                                                <option <?php echo e($project->is_featured == 1 ? 'selected' : ''); ?> value="1">
                                                    Featured</option>
                                                <option <?php echo e($project->is_featured == 0 ? 'selected' : ''); ?> value="0">
                                                    Not Featured</option>
                                            </select>
                                    ...
                                    <div class="col-6 p-2 text-center">
                                        <div>
                                            <?php if($project->image): ?>
                                                <img id="profileImage" src="<?php echo e(asset($project->image)); ?>" alt="Profile"
                                                    width="50%">
                                            <?php else: ?>
                                            ...
                                            <div class="pt-2">
                                                ...
                                                <div>
                                                    <?php if($project->video): ?>
                                                        <video id="videoTag" width="400" height="260" controls autoplay>
                                                            <source src="<?php echo e(asset($project->video)); ?>" type="video/mp4">
                                                            Your browser does not support the video tag.
                                                        </video>
                                                    <?php else: ?>
                                                        <video id="videoTag" width="400" height="260" controls
                                                            autoplay></video>
                                                    <?php endif; ?>
                                                </div>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="card">
                            <div class="card-body" style="height: 400px;padding-top: 20px;">
                                <div class="service-area-quill-editor-full" style="border: none;"><?php echo $project->description; ?>
...
unset($__errorArgs, $__bag); ?>"
                                                id="meta_title" value="<?php echo e($project->meta_title); ?>">
...
unset($__errorArgs, $__bag); ?>" id="meta_description"><?php echo e($project->meta_description); ?></textarea>
...
unset($__errorArgs, $__bag); ?>" id="meta_keywords"><?php echo e($project->meta_keywords); ?></textarea>
...
<?php echo $__env->make('admin.layouts.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/falconso/public_html/resources/views/admin/project/edit.blade.php ENDPATH**/ ?>