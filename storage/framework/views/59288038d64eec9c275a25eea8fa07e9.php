<?php $__env->startSection('title', 'About Content'); ?>
            ...
            <div class="row">
                ...
                <div class="col-lg-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form class="row g-2" action="<?php echo e(route('about.content.update', $pageData?->id)); ?>" method="POST"
                                ...
                                <div class="col-4 p-2 text-center">
                                    <div>
                                        <img id="profileImage"
                                            src="<?php echo e(asset($pageData?->image ? $pageData?->image : 'admin/assets/img/600X900.svg')); ?>"
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div class="quill-editor-about-content-full"><?php echo $pageData?->description; ?></div>
    ...
    <script>
        ...
        document.getElementById('removeImageButton').addEventListener('click', function(e) {
            ...
            document.getElementById('profileImage').setAttribute('src',
                '<?php echo e(asset('admin/assets/img/600X900.svg')); ?>');
        });
    </script>
<?php $__env->stopSection(); ?>

<?php echo $__env->make('admin.layouts.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/falconso/public_html/resources/views/admin/about/about.blade.php ENDPATH**/ ?>