            ...
            <div class="row">
                                                    ...
                                                    <div class="dropdown">
                                                        ...
                                                        <ul class="dropdown-menu">
                                                            <li><a class="dropdown-item"
                                                                    href="<?php echo e(route('business.edit', $item->id)); ?>"><i
                                                                        class="bx bxs-edit-alt"></i> Edit</a></li>
                                                            <li>
                                                                <form
                                                                    action="<?php echo e(route('business.destroy', $item->id)); ?>"
                                                                    method="POST">
                                                                    <?php echo csrf_field(); ?>
                                                            ...
                                                            <li>
                                                                <a href="<?php echo e(route('business.status.update', $item->id)); ?>"
                ...
                <div class="col-lg-4">
                    <div class="card">
                        <?php if($business): ?>
                            <div class="card-body">
                                <form class="row g-2" action="<?php echo e(route('business.update', $business->id)); ?>"
                                    ...
                                    <div class="mb-2">
                                            ...
                                            <select name="category_id" id="" class="form-control" required>
                                                ...
                                                <?php $__currentLoopData = $businessCategories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <option <?php echo e(($business->category_id == $category->id ? 'selected':'')); ?> value="<?php echo e($category->id); ?>"><?php echo e($category->name); ?></option>
                                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                            </select>
...
unset($__errorArgs, $__bag); ?>
                                    ...
                                    <div class="col-12">
                                        ...
                                        <input type="text" name="name" placeholder="Name"
                                            value="<?php echo e($business->name); ?>"
...
unset($__errorArgs, $__bag); ?>
                                    ...
                                    <div class="col-12">
                                        ...
                                        <input type="text" name="link" placeholder="Link"
                                            value="<?php echo e($business->link); ?>"
...
unset($__errorArgs, $__bag); ?>
                                    ...
                                    <div class="col-12">
                                        ...
                                        <select name="is_active" id="" class="form-control" required>
                                            <option <?php echo e($business->is_active == 1 ? 'selected' : ''); ?> value="1">Active
                                            </option>
                                            <option <?php echo e($business->is_active == 0 ? 'selected' : ''); ?> value="0">
                                                Inactive
                                            </option>
                                        </select>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <?php else: ?>
                            <div class="card-body">
                                <form class="row g-2" action="<?php echo e(route('business.store')); ?>" method="POST" enctype="multipart/form-data">
                                    <?php echo csrf_field(); ?>
                                    <div class="mb-2">
                                            <label for="category_id" class="form-label">Category</label>
                                            <select name="category_id" id="" class="form-control" required>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('admin.layouts.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/falconso/public_html/resources/views/admin/business/index.blade.php ENDPATH**/ ?>