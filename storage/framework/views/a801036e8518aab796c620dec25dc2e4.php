            ...
            <div class="row">
                                ...
                                <tbody>
                                    <?php $__currentLoopData = $clients; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <tr>
                                            ...
                                            <td><?php echo e($item->alt_name); ?></td>
                                                    ...
                                                    <div class="dropdown">
                                                        ...
                                                        <ul class="dropdown-menu">
                                                            <li><a class="dropdown-item"
                                                                    href="<?php echo e(route('client.edit', $item->id)); ?>"><i
                                                                        class="bx bxs-edit-alt"></i> Edit</a></li>
                                                            <li>
                                                                <form action="<?php echo e(route('client.destroy', $item->id)); ?>"
                                                                    method="POST">
                                                                    <?php echo csrf_field(); ?>
                                                            ...
                                                            <li>
                                                                <a href="<?php echo e(route('client.status.update', $item->id)); ?>"
                ...
                <div class="col-lg-4">
                    <div class="card">
                        <?php if($client): ?>
                            <div class="card-body">
                                <form class="row g-2" action="<?php echo e(route('client.update', $client->id)); ?>" method="POST"
                                    enctype="multipart/form-data">
                                    <?php echo csrf_field(); ?>
                                    <?php echo method_field('PUT'); ?>
                                    <div class="col-12 p-2 text-center">
                                        <div>
                                            <img id="profileImage" src="<?php echo e(asset($client->image)); ?>"
...
unset($__errorArgs, $__bag); ?>
                                    ...
                                    <div class="col-12 col-lg-6 col-md-6">
                                        ...
                                        <input type="text" name="alt_name" placeholder="Alter Name" value="<?php echo e($client->alt_name); ?>"
                                            class="form-control <?php $__errorArgs = ['alt_name'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
...
unset($__errorArgs, $__bag); ?>" id="alt_name">
                                        <?php $__errorArgs = ['alt_name'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>
                                    ...
                                    <div class="col-12 col-lg-6 col-md-6">
                                        ...
                                        <select name="is_active" id="" class="form-control" required>
                                            <option <?php echo e($client->is_active == 1 ? 'selected':''); ?> value="1">Active</option>
                                            <option <?php echo e($client->is_active == 0 ? 'selected':''); ?> value="0">Inactive</option>
                                        </select>
...
unset($__errorArgs, $__bag); ?>
                                    ...
                                    <div class="text-end">
                                        <a href="<?php echo e(route('client.index')); ?>" class="btn btn-sm btn-danger">Cancel</a>
                        ...
                        <?php else: ?>
                            <div class="card-body">
                                <form class="row g-2" action="<?php echo e(route('client.store')); ?>" method="POST"
                                    enctype="multipart/form-data">
                                    <?php echo csrf_field(); ?>
                                    <div class="col-12 p-2 text-center">
                                        <div>
                                            <img id="profileImage" src="<?php echo e(asset('admin/assets/img/350X165.svg')); ?>"
                                                alt="Client Iimage" width="30%">
                                            <div class="pt-2">
                                                <!-- Hidden File Input -->
                                                <input type="file" name="image" id="profileImageInput"
    ...
    <script>
        ...
        document.getElementById('removeImageButton').addEventListener('click', function(e) {
            ...
            document.getElementById('profileImage').setAttribute('src',
                '<?php echo e(asset('admin/assets/img/350X165.svg')); ?>');
        });
    </script>
<?php $__env->stopSection(); ?>

<?php echo $__env->make('admin.layouts.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/falconso/public_html/resources/views/admin/client/index.blade.php ENDPATH**/ ?>